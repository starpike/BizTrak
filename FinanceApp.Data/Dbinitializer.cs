    ...
    public static void Seed(FinanceAppDbContext financeAppDbContext)
    {
        ...
        "Assemble an Ikea sofa"
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                financeAppDbContext.Clients.Add(client);
                ...
                financeAppDbContext.Quotes.Add(quote);
                financeAppDbContext.SaveChanges();
                ...
                financeAppDbContext.Jobs.Add(job1);

                var job2 = new Job
                {
                    JobTitle = jobTitles[(jobIndex + 1) % jobTitles.Length],
                    Description = jobDescriptions[(jobIndex + 1) % jobTitles.Length],
                    EstimatedCost = 40m + random.Next(0, 100),
                    Quote = quote
                };

                financeAppDbContext.Jobs.Add(job2);
                financeAppDbContext.SaveChanges();
            }
        }
    }
